...
const Upload = () => {
  ...
  const uploadVideo = async (e: any) => {
    ...
    const fileTypes = ['video/mp4', 'videp/webm', 'video/ogg']
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] md-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
                  ...
                  <label className='cursor-pointer'>
                    <div className='flex flex-col items-center justify-center h-full'>
                      <div className='flex flex-col items-center justify-center'>
                        ...
                        <p className='text-gray-400'>Select video to upload</p>
                      </div>
                      <p className='text-gray-300 text-center mt-10 text-sm '>
